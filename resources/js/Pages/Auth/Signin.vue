        ...
        <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto px-4">
          <div>
            <div class="mb-5 sm:mb-8 text-center lg:text-left">
              ...
              <p class="text-sm text-gray-500 dark:text-gray-400">Enter your email and password to access the dashboard</p>
            </div>
            <form @submit.prevent="submit">
              <div class="space-y-5">
                <div>
                  ...
                  <input v-model="form.email" type="email" id="email" required placeholder="admin@elbildad.com" class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500 dark:border-gray-700 dark:text-white" />
                ...
                <div>
                  ...
                  <input v-model="form.password" type="password" id="password" required placeholder="••••••••" class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500 dark:border-gray-700 dark:text-white" />
                ...
                <div class="flex items-center justify-between">
                  <label class="flex items-center text-sm font-normal text-gray-700 cursor-pointer dark:text-gray-400">
                    <input v-model="form.remember" type="checkbox" class="mr-2 rounded border-gray-300 text-brand-500 focus:ring-brand-500" />
                    Remember me
                  </label>
                  <Link href="/forgot-password" class="text-sm text-brand-500 hover:text-brand-600">Forgot password?</Link>
                </div>
